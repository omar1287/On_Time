                  ...
                  children: [
                              ...
                              child: SizedBox(
                                ...
                                child: ElevatedButton(
                                  onPressed: () {
                                    ...
                                    if(HomeCubit.get(context).checkOutDate && HomeCubit.get(context).count<=2) {
                    ...
                    Card(
                      shape: RoundedRectangleBorder(
                        ...
                        //<-- SEE HERE
                        side: BorderSide(color: HexColor('#034488'), width: 1),
                      ),
                      child: Padding(
